...
function htmljs_Chat_Init( holder )
{
    ...
    var html =  "<div class=\"holder-html-chat\" >"
		  ...
		  + "<input type=\"text\" id=\"WebChatNameID\" class=\"html-chat-js-name\"  placeholder=\"Введите своё имя\" >"
	          + "<textarea id = \"WebChatTextID\" placeholder = \"Введите текст\" class=\"html-chat-js-input\" ></textarea>"

                  + "<div class=\"html-chat-js-button-holder\">"
                  +    "<input type=\"button\"  onclick=\"web_send_msg();\" value=\"Отправить сообщение\" >"
                  +    " <div class=\"html-chat-js-answer\"  ><a href=\"1\" id=\"answer\" target='__blank' ></a></div>"
                  + "</div>"
             +  "</div>";
    $(holder).html(html);
